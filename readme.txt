=== WP-CRM System Import Organizations ===
Tested up to: 5.0.3
Stable tag: 2.2.4
License: GPL2+
...
= 2.1.1 =
* Corrected export file column headings.
...
= 2.0.3 =
* Improved: Export file now includes organization ID number. Useful for creating import CSV files for contacts.
...
= 1.1.0 =
* Update includes ability to assign imported organizations to categories.
